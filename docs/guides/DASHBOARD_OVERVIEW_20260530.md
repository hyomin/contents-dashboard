...
> **빠른 요약:** [SUMMARY.md](../SUMMARY.md) — 최신 현황·우선순위·마이그레이션 목록  
> **목적:** 사이드바·각 화면·데이터·n8n 연동을 **한 문서에 상세** 정리합니다. PC 이전·새 Agent 세션·기획 회고 시 참고합니다.  
> **작성 기준일:** 2026-05-30 (SUMMARY는 2026-05-31에 통합 갱신)  
