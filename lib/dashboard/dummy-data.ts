...
export const COMPETITOR_CHANNELS = [
  { id: 7, name: '@시니어재테크',   platform: 'tiktok' as const,     subs: 128000, avgViews: 18500, videos: 89,  topKeyword: '연금/재테크',     tier: 'A', tracked: true },
  { id: 8, name: '@경제한줄',       platform: 'tiktok' as const,     subs: 89000,  avgViews: 12200, videos: 54,  topKeyword: '금리/시사',       tier: 'B', tracked: true },
...
export const MY_CHANNELS = [
  ...
  { id: 5, name: '내 TikTok',        platform: 'tiktok' as const,     subs: 0,   videos: 0, status: '준비중', goal: 5000 },
]
...
export const CALENDAR_ITEMS = [
  ...
  { id: 8, day: '2일 후', title: '연금 개편 TikTok 숏폼',         platform: 'tiktok' as const,     status: 'draft',     time: '오후 8시' },
]
...
export const COLLECT_JOBS = [
  ...
  { id: 5, name: 'TikTok (Apify)',     platform: 'tiktok' as const,     lastRun: '더미',      status: 'idle',    count: 6,  next: 'Apify 연동 후' },
...
export const REVENUE_DATA = [
  ...
  { platform: 'tiktok' as const,     label: 'TikTok Creator',  monthly: 0, rpm: 0,    status: 'inactive', goal: 30000 },
