/** 자동 수집 파이프라인이 연결된 플랫폼 (YouTube만 운영 중) */
export const PLATFORMS_WITH_COLLECTION = ['youtube'] as const

/** 더미 데이터로 UI 미리보기 (Apify 연동 예정) */
export const PLATFORMS_DUMMY_PREVIEW = ['tiktok'] as const

/** UI만 제공 · 수집 미구현 */
export const PLATFORMS_COMING_SOON = ['instagram', 'naver-blog', 'tistory'] as const
