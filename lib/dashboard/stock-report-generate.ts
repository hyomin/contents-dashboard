...
반드시 JSON만 응답:
{
  ...
  "fullContent": "마크다운 전체 본문 (오늘의 시세·등락 요약 → 최근 시세 패턴분석 표 → 공개정보·예정 이벤트 → 고정 디스클레이머, 차트 이미지 가이드 블록 포함)",
  "summary": "작성 요약 2~3문장",
...
반드시 JSON만 응답:
{
  ...
  "fullContent": "마크다운 전체 본문 (종목 개요·이슈 → 가격 추이·패턴분석 표 → 업종/거시 맥락 → 고정 디스클레이머, 차트 이미지 가이드 블록 포함)",
  "summary": "작성 요약 2~3문장",
  "imageGuideCount": ${imageGuideCount},
  "seoKeywords": ["키워드1", "키워드2"],
  "chapterSummary": ["소제목1", "소제목2"],
...
반드시 JSON만 응답:
{
  ...
  "fullContent": "마크다운 전체 본문 (섹터 개요·최근 화두 → 구성종목별 가격추이 비교표 → 섹터 공통 거시/이벤트 맥락 → 고정 디스클레이머, 차트 이미지 가이드 블록 포함)",
  "summary": "작성 요약 2~3문장",
  "imageGuideCount": ${imageGuideCount},
  "seoKeywords": ["키워드1", "키워드2"],
  "chapterSummary": ["소제목1", "소제목2"],
