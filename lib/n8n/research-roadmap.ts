...
export const N8N_AUTOMATION_ROADMAP: N8nAutomationService[] = [
  ...
  },
  {
    ...
    description: '주제 키워드 입력 → Gemini가 8분 구조(훅·챕터·CTA) 스크립트 초안 생성 (Google Docs 저장 없이 대시보드에서 바로 확인)',
    category: 'content',
    status: 'done',
    coreNodes: 'Webhook · Gemini API · 대시보드 API',
    ...
    integrationMode: 'hybrid',
    api: { method: 'POST', path: '/api/dashboard/content-generate', label: '롱폼 스크립트 생성' },
