...
const GROUP_STYLES: Record<string, GroupStyle> = {
  ...
  create: {
    openBg: 'bg-green-50 dark:bg-green-950/35',
    hoverBg: 'hover:bg-green-50/70 dark:hover:bg-green-950/20',
    stripe: 'bg-green-600',
    childBorder: 'border-green-200 dark:border-green-800/60',
    activeBg: 'bg-green-600 text-white',
    openText: 'text-green-900 dark:text-green-100',
  ...
  'channel-register': {
    openBg: 'bg-sky-50 dark:bg-sky-950/35',
    hoverBg: 'hover:bg-sky-50/70 dark:hover:bg-sky-950/20',
    stripe: 'bg-sky-500',
    childBorder: 'border-sky-200 dark:border-sky-800/60',
    activeBg: 'bg-sky-600 text-white',
    openText: 'text-sky-900 dark:text-sky-100',
    iconBg: 'bg-sky-100 dark:bg-sky-900/45',
  },
  'my-channels': {
